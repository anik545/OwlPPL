...
\begin{tikzpicture}
	...
	\begin{groupplot}[
		...
		%
		\nextgroupplot[title=Linear Regression, legend style={at={($(0,0)+(2cm,2cm)$)}, legend columns=3},legend to name=leg1]
		...
		\addlegendentryexpanded{Metropolis Hastings}
		% 
		...
		\addlegendentryexpanded{Rejection Sampling}
		% 
		...
		\addlegendentryexpanded{Particle Filter}
		% 
		...
		\addlegendentryexpanded{Importance Sampling}
		% 
		...
		\addlegendentryexpanded{Particle Cascade}
		% 
		...
		\addplot [fill=teal!50, fill opacity=0.5,forget plot] fill between[of=upper3 and lower3];
		\addplot [teal,mark=*] table [x index=0, y index=1, col sep=comma] {data/perf/by_datasize/linreg_by_data_length_pimh.csv};
		\addlegendentryexpanded{Particle-Indepependent MH}
