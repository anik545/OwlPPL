...
An important feature of this type is that it is polymorphic - this allows distributions to be defined over any type. Usually, this type is floats or ints, but polymorphism allows us to define distributions over anything, including distributions over distributions - a feature used in certain models such as a Dirichlet process.
...
\begin{figure}[!htb]
	...
	\caption{The pdf and cdf of a binomial distribution visualised}
	\label{fig:vis-binom}
\end{figure}
...
\begin{figure}[!htb]
	...
	\caption{The pdf and cdf of a normal distribution visualised}
	\label{fig:vis-norm}
\end{figure}
...
\begin{figure}[!htb]
	\centering			
	\caption{The Q-Q and P-P plots of the output of inference for a biased coin model}
	\label{fig:vis-qq}
\end{figure}
...
\begin{figure}[!htb]
	...
	\caption{The approsimate and exact pdf of the output of inference for a biased coin model}
...
The test output can be seen below, in figure \ref{fig:test-out}
\begin{figure}[!htb]
	\centering
