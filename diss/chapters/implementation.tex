...
\begin{figure}[!htb]
	...
	% \qquad
	% \subfloat[P-P plot]{{\includegraphics[width=0.4\textwidth]{figs/coin_compare.png} }}%
...
\begin{figure}[!htb]
	\centering
	\subfloat[Test report]{{\includegraphics[width=0.4\textwidth]{figs/bins.png} }}%
	\qquad
	\subfloat[Code coverage report]{{\includegraphics[width=0.4\textwidth]{figs/sprinkler-network.png} }}%
