...
\begin{figure}[!ht]
	...
	\perfgraph{data/times_rej.csv}{Rejection}{time (ms)}
	\caption{Performance of my ppl against other languages for different models, all using an MCMC algorithm, taking 10,000 samples from the posterior, averaged over 20 runs.Error bars show the 95\% confidence interval}
	\label{fig:time-perf}
\end{figure}
...
\begin{figure}[!ht]
	...
	\perfgraph{data/mems_rej.csv}{Rejection}{memory usage (bytes)}
