...
\newmintedfile[jscode]{javascript}{frame=single,framesep=10pt}
\newmintedfile[clojurecode]{javascript}{frame=single,framesep=10pt}
% \newcommand{\ocamlcode}[1]{}
\newminted[ocamlcode-in]{ocaml}{frame=single,framesep=10pt}
