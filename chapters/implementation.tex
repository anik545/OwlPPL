...
The type of a primitive distribution is \mintinline{ocaml}|type 'a prim_dist = (module PRIM_DIST with type t='a)|, with the \texttt{PRIM\_DIST} signature defined as in listing \ref{lst:prim-sig}. 
...
% I tested that my set of models compiles and can be sampled from (after inference), but didnt test the output samples
