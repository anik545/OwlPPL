...
\begin{tikzpicture}
	\pgfplotstableread[col sep = comma]{data/times_coin.csv}\t														
	\begin{groupplot}[
			group style={
				group name=my plots,
				group size=2 by 2,
